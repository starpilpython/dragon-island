...
const emit = defineEmits(['close', 'read-story', 'delete'])
    ...
    <div class="modal-content">
      ...
      <div class="action-area">
        ...
        <button class="delete-btn" @click="handleDelete">
          <div class="btn-icon-box">
             <img src="../assets/s07_icon2.png" class="btn-asset-icon trash" alt="Delete Icon" />
          </div>
...
.delete-btn {
  background: #ffab91; /* 요청사항: ResultSuccess 아이콘2와 유사한 주황/산호색 */
}

.story-btn:hover, .delete-btn:hover {
